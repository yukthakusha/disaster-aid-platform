...
router.post('/', (req, res) => {
    ...
    const sql = `INSERT INTO resource_requests (name, phone, location, resource_type) VALUES (?, ?, ?, ?)`;
...
// GET /api/resources — Fetch all requests
router.get('/', (req, res) => {
...
// PUT /api/resources/:id — Update request status
